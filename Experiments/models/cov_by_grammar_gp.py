...
class Venture_GP_Model(Venture_GP_model):
    def __init__(self):
    ...
    def make_gp(self, ripl):
        ...
        ripl.assume('per1', "(apply_function make_periodic ( l 3) ( p 3) ( sf 3) )")
        ripl.assume('se1', "(apply_function make_se ( sf2 4) ( l2 4))")
        ripl.assume('se2', "(apply_function make_se ( sf2 5) ( l2 5))")
