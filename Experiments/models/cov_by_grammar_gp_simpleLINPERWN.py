...
class Grammar_Venture_GP_model_simpleLINPERWN(Venture_GP_model):
    def __init__(self):
    ...
    def make_gp(self, ripl):
        ...
        #ripl.assume('se1', "(apply_function make_se ( sf2 4) ( l2 5))")
        ...
        ripl.assume("cov_structure","(tag (quote grammar) 0 (gp_grammar (array max_lin max_wn  max_per ) number_components ))")
