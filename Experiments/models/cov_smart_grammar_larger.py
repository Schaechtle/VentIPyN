...
class Grammar_Venture_GP_model_Smart_larger(Venture_GP_model):
    def __init__(self):
    ...
    def make_gp(self, ripl):
        ...
        ripl.assume('a1',' (tag (quote 0 ) 0 (uniform_continuous  0 10))')
        ...
        ripl.assume('a2',' (tag (quote 5 ) 0 (uniform_continuous  0 10))')

        ripl.assume('ell2',' (tag (quote 6 ) 0 (uniform_continuous  0 10))')
        ripl.assume('sf3',' (tag (quote 6 ) 1 (uniform_continuous  0 10))')


        ripl.assume('lin', "(apply_function make_linear a1  0 )")
        ...
        ripl.assume('lin2', "(apply_function make_linear a2  5 )")
        ripl.assume('se2', "(apply_function make_se ell2 sf3 6 )")
         #### GP Structure Prior
        ...
        ripl.assume('cov_list','(list lin per se wn lin2 se2)')
