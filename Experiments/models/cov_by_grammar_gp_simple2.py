...
class Grammar_Venture_GP_model_simple2(Venture_GP_model):
    def __init__(self):
    ...
    def make_gp(self, ripl):
        ...
        ripl.assume('per1', "(apply_function make_periodic ( l 1) ( p 2) ( sf 3) )")
        ...
        ripl.assume("number_components","(tag (quote parameter) 4 (categorical "+simplex+"))")
        ...
        ripl.assume("cov_structure","(tag (quote grammar) 0 (gp_grammar (array max_lin  max_per ) number_components ))")
